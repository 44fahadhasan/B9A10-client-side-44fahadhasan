    ...
    fetch(`http://localhost:5003/add-craft-item/${crafData._id}`, {
      ...
      .then((data) => {
        if (data.acknowledged) {
          Swal.fire({
            title: "success!",
            text: "Craft item updated succesfull",
            icon: "success",
      ...
      <div className="w-full  shadow-md mx-auto md:w-[70%] lg:w-[60%] border rounded-md py-10 px-5 md:px-10">
        <div className="text-center mb-10">
          <SectionContent
            leftTitle="Update"
            rightTitle="Craft"
            content="provide craft information to update"
          />
        </div>
        <div>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-1 text-base">
              ...
              <input
                ...
                type="text"
                defaultValue={crafData.userName}
                name="userName"
            ...
            <div className="space-y-1 text-base">
              ...
              <input
                ...
                type="text"
                defaultValue={crafData.craftName}
                name="craftName"
  ...
  "
            ...
            <div className="space-y-1 text-base">
              ...
              <input
                ...
                type="text"
                defaultValue={crafData.category}
                name="category"
            ...
            <div className="space-y-1  text-base">
              ...
              <input
                ...
                type="url"
                defaultValue={crafData.imageurl}
                name="imageurl"
            ...
            <div className="flex flex-col lg:flex-row gap-x-4 gap-y-1">
              ...
              <div className="pt-4 lg:pt-0 text-base">
                ...
                <input
                  ...
                  type="text"
                  defaultValue={crafData.stockStatus}
                  name="stockStatus"
            ...
            <div className="flex flex-col lg:flex-row gap-x-4 ">
              <div className="text-base">
                ...
                <input
                  ...
                  type="text"
                  defaultValue={crafData.customization}
                  name="customization"
                  placeholder="Yes/No"
                  className="w-full  pl-10 pr-3 py-2 rounded-lg border-2 border-[#E9E9E9] text-secondary-content outline-none focus:border-primary bg-accent-content"
                />
              ...
              <div className="pt-5 lg:pt-0 text-base">
                ...
                <input
                  ...
                  type="text"
                  defaultValue={crafData.processingTime}
                  name="processingTime"
                  placeholder="3 days"
                  className="w-full  pl-10 pr-3 py-2 rounded-lg border-2 border-[#E9E9E9] text-secondary-content outline-none focus:border-primary bg-accent-content"
                />
