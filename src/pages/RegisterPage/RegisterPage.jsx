...
const RegisterPage = () => {
  ...
  return (
    <section className="container w-[87%] mx-auto poppins">
      <Tost />
      <div className="min-w-screen min-h-screen bg-accent-content flex items-center justify-center px-5 py-5">
        <div className="bg-accent-content text-primary-content  w-full overflow-hidden">
          <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-base-200 py-10 px-10 rounded-md">
              <svg
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-1  text-base">
                    ...
                    <input
                      ...
                      type="url"
                      name="photourl"
                      placeholder="https://example.photos/johndoe"
                      className="w-full  pl-10 pr-3 py-2 rounded-lg border-2 border-[#E9E9E9] text-secondary-content outline-none focus:border-primary bg-accent-content"
                    />
                  </div>
                  <div className="space-y-1  text-base">
