const FooterBottom = () => {
  return (
    <div className="flex flex-col md:flex-row gap-4  justify-between items-center py-8 text-[15px] text-secondary-content">
      <div className="text-center">
        <p>Copyright © 2024 TerraCotta. All Rights Reserved.</p>
      </div>
      <div className="">
