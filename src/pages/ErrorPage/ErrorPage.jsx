...
const ErrorPage = () => {
  return (
    <section className="bg-accent-content">
      <div className="container w-[87%] mx-auto  poppins  flex items-center h-screen ">
        <div className="container flex flex-col md:flex-row items-center justify-center px-5">
          <div className="max-w-md space-y-3">
            <h1 className="dmsans text-5xl text-primary-content font-bold">
              404
            </h1>
            <p className="text-2xl md:text-3xl text-primary-content font-light leading-normal">
              Sorry we couldn&#39;t find this page.
            </p>
            <p className="pb-8 text-[15px] text-secondary-content ">
          ...
          <div className="max-w-lg">
            ...
            >
              ...
              ></path>
              <path className="cls-8" d="M1560.5,1428.5s69-32,85-94"></path>
              <path
                className="cls-7"
              ...
              <ellipse
                ...
                ry="117"
              ></ellipse>
              <circle className="cls-9" cx="1355" cy="991" r="31.5"></circle>
              <path
                className="cls-10"
              ...
              ></path>
              <circle className="cls-12" cx="1355" cy="991" r="22.5"></circle>
              <circle className="cls-9" cx="1557" cy="991" r="31.5"></circle>
              <circle className="cls-12" cx="1557" cy="991" r="22.5"></circle>
              <path
                className="cls-10"
              ...
              ></path>
              <path className="cls-14" d="M1664.5,1001.5,1735,980"></path>
              <path className="cls-14" d="M1667,1017l66.5,10.5"></path>
              <path className="cls-14" d="M1244,1017l-60.5,13.5"></path>
              <path className="cls-14" d="M1246.5,1000.5,1180,990"></path>
              <path
                className="cls-15"
